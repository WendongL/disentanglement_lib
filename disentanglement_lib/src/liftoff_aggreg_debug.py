...
def run(params):
    ...
    pattern = os.path.join(out_dir,
                        "0013_train.HsicBetaVAE.beta_1.0__train.HsicBetaVAE.alpha_1.0/*/representation/@mean_representation/0/metrics/"+params.evaluation.evaluation.evaluation_fn+"/*/results/aggregate/evaluation.json")
    results_path = os.path.join(out_dir, "results_"+metric_name+"._debug.json")
    print(pattern)
